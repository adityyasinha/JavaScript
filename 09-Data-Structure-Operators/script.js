...
// Arrays
const users = [{ name: 'Aditya', email: 'hello@aditya.io' }];
// const users = [];
...
console.log(new Set('AdityaSinha').size);
*/
...
console.log('Aditya Sinha'.split(' '));

const [firstName, lastName] = 'Aditya Sinha'.split(' ');
